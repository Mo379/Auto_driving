...
class DataLoader:
    ...
    def Load_all_batches(self, data, data_shape=(-1,1)):
        ...
        loaded_set_features = np.array(loaded_set_features,dtype=np.float32)/255
        loaded_set_labels= np.array(loaded_set_labels,dtype=np.float32)/255
    ...
    def Load_batch(self, batch, data_shape=(-1,1), augmentation=False, augmentation_pass = 3):
        ...
        loaded_set_features = np.array(X,dtype=np.float32)/255
